...
const translations = {
  ...
  es: {
    title: 'Expresar Interes',
    backToSearch: 'Volver a Busqueda de Proveedores',
    providerLabel: 'Proveedor',
    contactMethodLabel: 'Metodo de Contacto Preferido',
    contactMethodPhone: 'Telefono',
    contactMethodEmail: 'Correo Electronico',
    ...
    notesPlaceholder: 'Cualquier informacion adicional que desee compartir...',
    submit: 'Enviar',
    submitting: 'Enviando...',
    error: 'Hubo un error al enviar su interes. Por favor intente de nuevo.',
    phoneRequired: 'El numero de telefono es requerido para contacto por telefono o texto.',
    emailRequired: 'El correo electronico es requerido para contacto por correo.',
    screenerInfo: 'Informacion del Cuestionario de Elegibilidad',
    zipCode: 'Codigo Postal',
    childAge: 'Rango de Edad del Nino',
...
const ageLabels = {
  ...
  es: {
    [AgeRange.INFANT]: 'Bebe (0-12 meses)',
    [AgeRange.TODDLER]: 'Nino Pequeno (1-3 anos)',
    [AgeRange.PRESCHOOL]: 'Preescolar (3-5 anos)',
    [AgeRange.SCHOOL_AGE]: 'Edad Escolar (5+ anos)',
  },
};
...
const careLabels = {
  ...
  es: {
    [CareType.FULL_DAY]: 'Dia Completo',
    [CareType.PART_DAY]: 'Medio Dia',
    [CareType.BEFORE_AFTER_SCHOOL]: 'Antes/Despues de la Escuela',
